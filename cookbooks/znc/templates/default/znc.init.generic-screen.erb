...
# Default-Stop:      0 1 6
# Short-Description: ZNC-screen RC shell script.
# Description:       ZNC-screen RC shell script using GNU Screen.
### END INIT INFO
...
do_start()
{
	...
	start-stop-daemon --start --quiet --chuid "$USER:$GROUP" --pidfile "$PIDFILE" --exec "screen -S znc $DAEMON" --test > /dev/null \
    || return 1
